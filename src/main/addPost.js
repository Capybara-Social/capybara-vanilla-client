...
plantilla.id = "";
const coming = "";
import videoLoad from "../_generals/videoPlayer.js";
...
function loadHuff(huff){
	...
	//publisher
	instance.children[0].href = coming + "/users/@" + user.username;
	...
	instance.children[3].children[1].href = coming + "/huffs/" + huff.id + "?from=main";
	if(!huff.sponsor) instance.children[2].remove();
	instance.removeAttribute("style");
	mainC.prepend(instance);
}
